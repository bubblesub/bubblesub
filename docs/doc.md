...
|`audio/snap‑sel‑to‑keyframe` | <a name="cmd-audio-snap-sel-to-keyframe"></a>Snaps the spectrogram selection to the nearest keyframe.<br>Parameters:<br><ol><li>shift_target (string): how to snap the selection</li><li>snap_direction (string): direction to stap into</li></ol> |
|`audio/snap‑sel‑to‑sub` | <a name="cmd-audio-snap-sel-to-sub"></a>Snaps the spectrogram selection to the nearest subtitle.<br>Parameters:<br><ol><li>shift_target (string): how to snap the selection</li><li>snap_direction (string): direction to stap into</li></ol> |
|`audio/snap‑sel‑to‑video` | <a name="cmd-audio-snap-sel-to-video"></a>Snaps the spectrogram selection to nearest video frame.<br>Parameters:<br><ol><li>shift_target (string): how to snap the selection</li></ol> |
