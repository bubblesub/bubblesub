...
_DEFAULT_MAIN_MENU: T.MutableSequence[MenuItem] = [
    ...
    SubMenu('&Timing', [
        ...
        SubMenu('Snap to current video frame', [
            MenuCommand('/audio-shift-sel -d=current-frame --start'),
            MenuCommand('/audio-shift-sel -d=current-frame --end'),
            MenuCommand(
        ...
        SubMenu('Shift', [
            ...
            MenuCommand('/audio-shift-sel -d=+1f --end'),
            MenuCommand('/edit/shift-subs -d=-1000 -t=start'),
            MenuCommand('/edit/shift-subs -d=+1000 -t=start'),
            MenuCommand('/edit/shift-subs -d=-1000 -t=end'),
            MenuCommand('/edit/shift-subs -d=+1000 -t=end'),
        ]),
