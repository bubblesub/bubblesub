...
class MenuCommand(MenuItem):
    ...
    def __init__(
        ...
        :param name: name that overrides names determined by commands
...
_DEFAULT_MAIN_MENU: T.MutableSequence[MenuItem] = [
    ...
    SubMenu('&Edit', [
        ...
        MenuSeparator(),
        MenuCommand('/sub-insert --before'),
        MenuCommand('/sub-insert --after'),
        ...
        MenuCommand('/sub-paste --before'),
        MenuCommand('/sub-paste --after'),
        MenuCommand('/sub-paste-into -s=times'),
        MenuCommand('/sub-paste-into -s=text'),
        MenuSeparator(),
