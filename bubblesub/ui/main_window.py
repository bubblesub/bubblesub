    ...
    def _setup_menu(self):
        ...
        menu = {
            ...
            '&Edit': [
                ...
                ('Shift selection start (-250 ms)', 'Ctrl+Shift+1', 'edit/move-sel-start', -250),
                ('Shift selection start (+250 ms)', 'Ctrl+Shift+2', 'edit/move-sel-start', 250),
                ('Shift selection end (-250 ms)', 'Ctrl+Shift+3', 'edit/move-sel-end', -250),
                ('Shift selection end (+250 ms)', 'Ctrl+Shift+4', 'edit/move-sel-end', 250),
                ('Shift selection start (-25 ms)', 'Ctrl+1', 'edit/move-sel-start', -25),
                ('Shift selection start (+25 ms)', 'Ctrl+2', 'edit/move-sel-start', 25),
                ('Shift selection end (-25 ms)', 'Ctrl+3', 'edit/move-sel-end', -25),
                ('Shift selection end (+25 ms)', 'Ctrl+4', 'edit/move-sel-end', 25),
