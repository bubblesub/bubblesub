...
class LightTheme(BaseTheme):
    ...
    def palette(self) -> T.Dict[str, str]:
        return {
            ...
            "spectrogram/selected-sub-text": "#00000064",
            "spectrogram/selected-sub-line": "#2A82DADC",
            "spectrogram/selected-sub-fill": "#2A82DA32",
            "spectrogram/unselected-sub-text": "#00000032",
            "spectrogram/unselected-sub-line": "#2A82DA78",
            "spectrogram/unselected-sub-fill": "#2A82DA1E",
            "spectrogram/selected-label-text": "#FFFFFF",
            "spectrogram/selected-label-line": "#2A82DADC",
            "spectrogram/selected-label-fill": "#2A82DADC",
            "spectrogram/unselected-label-text": "#000000",
            "spectrogram/unselected-label-line": "#2A82DA78",
            "spectrogram/unselected-label-fill": "#E1EAE5",
