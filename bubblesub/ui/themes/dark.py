...
class DarkTheme(BaseTheme):
    ...
    def palette(self) -> T.Dict[str, str]:
        return {
            ...
            "spectrogram/selected-sub-text": "#64646464",
            "spectrogram/selected-sub-line": "#2A82DADC",
            "spectrogram/selected-sub-fill": "#2A82DA32",
            "spectrogram/unselected-sub-text": "#64646432",
            ...
            "spectrogram/unselected-label-text": "#646464",
            "spectrogram/unselected-label-line": "#2A82DA78",
            "spectrogram/unselected-label-fill": "#323232",
