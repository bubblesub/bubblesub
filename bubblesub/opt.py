...
_DEFAULT_HOTKEYS = {
    'global': [
        ...
        ('Ctrl+.', 'video/step-frame', 1),
        ('Ctrl+Shift+,', 'video/step-ms', -500, False),
        ('Ctrl+Shift+.', 'video/step-ms', 500, False),
        ...
        ('Ctrl+Shift+1', 'audio/shift-sel-start', -10),
        ('Ctrl+Shift+2', 'audio/shift-sel-start', 10),
        ('Ctrl+Shift+3', 'audio/shift-sel-end', -10),
        ('Ctrl+Shift+4', 'audio/shift-sel-end', 10),
        ('Ctrl+1', 'audio/shift-sel-start', -1),
        ('Ctrl+2', 'audio/shift-sel-start', 1),
        ('Ctrl+3', 'audio/shift-sel-end', -1),
        ('Ctrl+4', 'audio/shift-sel-end', 1),
    ...
    'audio': [
        ('Shift+1', 'audio/shift-sel-start', -10),
        ('Shift+2', 'audio/shift-sel-start', 10),
        ('Shift+3', 'audio/shift-sel-end', -10),
        ('Shift+4', 'audio/shift-sel-end', 10),
        ('1', 'audio/shift-sel-start', -1),
        ('2', 'audio/shift-sel-start', 1),
        ('3', 'audio/shift-sel-end', -1),
        ('4', 'audio/shift-sel-end', 1),
        ('C', 'audio/commit-sel'),
        ('K', 'edit/insert-above'),
        ('J', 'edit/insert-below'),
        ...
        (',', 'video/step-frame', -1),
        ('.', 'video/step-frame', 1),
        ('Ctrl+Shift+,', 'video/step-ms', -1500, False),
        ('Ctrl+Shift+.', 'video/step-ms', 1500, False),
        ('Shift+,', 'video/step-ms', -500, False),
        ('Shift+.', 'video/step-ms', 500, False),
...
_DEFAULT_TOP_MENU = [
    ...
    ['&Timing', [
        ...
        ['Shift selection', [
            ['audio/shift-sel-start', -10],
            ['audio/shift-sel-start', 10],
            ['audio/shift-sel-end', -10],
            ['audio/shift-sel-end', 10],
            ['audio/shift-sel-start', -1],
            ['audio/shift-sel-start', 1],
            ['audio/shift-sel-end', -1],
            ['audio/shift-sel-end', 1],
        ]],
        ['audio/commit-sel'],
        None,
