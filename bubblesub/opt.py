...
_DEFAULT_TOP_MENU = [
    ...
    ('&Timing', [
        ...
        None,
        ('Shift times...', 'edit/shift-subs-with-gui'),
        None,
    ...
    ('&Edit', [
        ...
        ('Copy selected subtitles text', 'grid/copy-text-to-clipboard'),
        None,
        ...
        None,
        ('Copy times to clipboard', 'grid/copy-times-to-clipboard'),
        ('Paste times from clipboard', 'grid/paste-times-from-clipboard'),
        None,
